...
components.html(
    ...
    <div style="color:blue;text-align:center; 
        ...
        font-size: 60px;">Face Product Recommendation System</h1>
    </div>
    """
...
file = st.file_uploader("Please upload an face image",type=['JPEG','jpg']) # file uploader functions
